...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/root/autodl-tmp/nutrgbd_raw/nturgb+d_skeletons/')
    parser.add_argument('--ignored_sample_path',
                        default='/root/autodl-tmp/nutrgbd_raw/samples_with_missing_skeletons.txt')
